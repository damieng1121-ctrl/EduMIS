      ...
      {open && (
        <div className="absolute right-0 top-full z-30 mt-1 w-64 rounded-lg border border-slate-200 bg-white p-4 text-sm shadow-lg dark:border-slate-700 dark:bg-slate-800">
          ...
          <p className="mt-1 text-slate-600 dark:text-slate-300">
            If you&apos;re stuck or something doesn&apos;t look right, email support and we&apos;ll help you out.
          </p>
          <a
            href={`mailto:${SUPPORT_EMAIL}`}
            className="mt-3 flex items-center gap-2 rounded-md bg-indigo-500 px-3 py-2 font-medium text-white transition-colors hover:bg-indigo-600"
          >
